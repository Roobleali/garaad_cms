            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed inset-0 z-[10000] overflow-y-auto">
                    <div className="flex min-h-screen items-center justify-center p-4">
                        <div
                            className="relative w-full max-w-4xl bg-white shadow-2xl rounded-xl my-8 animate-fade-in animate-zoom-in"
                            style={{ transform: 'none' }}
                        >
                            <div className="flex flex-col" style={{ maxHeight: 'calc(100vh - 64px)' }}>
                                <div className="flex-none border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-t-xl">
